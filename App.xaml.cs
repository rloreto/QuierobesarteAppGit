...
namespace QuierobesarteApp
{
    public partial class App : Application
    {
        ...
        {
            Utils.SerializeAppData(null);
        }

        private static async System.Threading.Tasks.Task Navigate()
        {
            Uri navigationUrl;
            var appData = await Utils.DeserializeAppData();

            if (appData != null)
            {
                navigationUrl = new Uri("/Views/UploaderPage.xaml?weddingId=" + appData.CurrentWeddingId, UriKind.Relative);
            }
            else
            {
